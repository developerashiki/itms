            ...
            <div class="row pt-5">
                <div class="col-md-6 col-sm-6">
                    <div id="about-section-left">
                        <h5>Overview:</h5>
                        <p>
                            Civil engineering plays a vital role in shaping the world we live in. It is involved in the development of transportation networks, water supply and sanitation systems, sustainable buildings, and infrastructure that enables economic growth and enhances the quality of life. Civil engineers work on a wide variety of projects, ranging from small residential buildings to massive infrastructure projects like dams, airports, and skyscrapers. They need a strong understanding of mathematics, physics, and various engineering principles to address the complex challenges posed by the built environment.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-section-right">
                        <img src="assets/images/civil.jpg" alt="about" />
                    </div>
                </div>
            </div>
        </div>
