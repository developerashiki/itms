			...
			<div class="col-md-12">
				<div class="header-slider-logo">
					<div class="logo">
						...
						<h2>Industrial Training Management System</h2>
				...
				<div class="col-md-4 col-sm-12">
					<div class="important-link">
						...
						<ul>
							...
							<li><i class="fa-solid fa-caret-right"></i> <a href="http://www.bteb.gov.bd/">বাংলাদেশ কারিগরি শিক্ষা বোর্ড</a></li>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="webdesign.php"><img src="assets/images/course/1.jpg" alt="" /></a>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="programming.php"><img src="assets/images/course/2.jpg" alt="" /></a>
						<h2>Programming</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="datacommunicatin.php"><img src="assets/images/course/3.jpg" alt="" /></a>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="electrical.php"><img src="assets/images/course/4.jpg" alt="" /></a>
						<h2>Electrical</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="civil.php"><img src="assets/images/service/3.jpg" alt="" /></a>
						<h2>Civil</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="architect.php"><img src="assets/images/course/6.jpg" alt="" /></a>
						<h2>Architecture</h2>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="about-section-left">
						<h5>About</h5>
						<h2>Industrial Training Management System</h2>
						<p>Industrial Training Management System is a professional Web Design & Development, Electrical and Civil, Architechture, services to clients all over the world.</p>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
