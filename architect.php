            ...
            <div class="row pt-5">
                <div class="col-md-6 col-sm-6">
                    <div id="about-section-left">
                        <h5>Overview:</h5>
                        <p>
                            Architecture is the art, science, and practice of designing and constructing buildings and other physical structures that serve as functional spaces for human use and shelter. Architects are professionals who combine creativity, technical knowledge, and practical skills to create aesthetically pleasing and functional spaces that meet the needs of individuals and communities. Here's an overview of key aspects and principles related to architecture.The architectural design process involves conceiving, planning, and creating a building or space. It includes understanding the requirements of the client or users, analyzing the site and its context, generating design ideas, and developing detailed plans and drawings.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-section-right">
                        <img src="assets/images/1605-Architecture-Creativity-wHY-Louisville-Speed-Art-Museum-01.jpg" alt="about" />
                    </div>
                </div>
            </div>
        </div>
