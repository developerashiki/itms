...
<body>
    ...
    <div class="about-aria section-padding">
        <h1 class="text-center">ELECTRICAL</h1>
        <div class="container">
            <div class="row pt-5">
                <div class="col-md-6 col-sm-6">
                    <div id="about-section-left">
                        <h5>Overview:</h5>
                        <p>
                            Electrical engineering is a field of engineering that deals with the study and application of electricity, electromagnetism, and electronics. It involves the design, development, testing, and maintenance of electrical systems and devices, ranging from small electronic components to large power generation and distribution systems. Here's an overview of the key aspects and subfields of electrical engineering.Electromagnetism is a fundamental concept in electrical engineering. It studies the relationship between electricity and magnetism and the behavior of charged particles and magnetic fields.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-section-right">
                        <img src="assets/images/eee.jpg" alt="about" />
                    </div>
                </div>
            </div>
        </div>
