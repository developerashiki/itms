...
<body>
    ...
    <div class="about-aria section-padding">
        <h1 class="text-center">DATA COMMUNICATON SYSTEM</h1>
        <div class="container">
            <div class="row pt-5">
                <div class="col-md-6 col-sm-6">
                    <div id="about-section-left">
                        <h5>Overview:</h5>
                        <p>Data Communication System (also known as Data Communications or Datacom) refers to the process of transmitting and receiving data between two or more devices or systems over a communication medium. It is an essential aspect of modern technology and underpins the functioning of the internet, computer networks, telecommunications, and various other digital systems. Here's an overview of the key components and concepts of a data communication system.</p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="about-section-right">
                        <img src="assets/images/Data-communication-diagram-of-the-system.png" alt="about" />
                    </div>
                </div>
            </div>
        </div>
