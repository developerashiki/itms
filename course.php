			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						...
						<a href="webdesign.php"><img src=" assets/images/service/1.jpg" alt="" />
							<h2>Learn Web Course</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="programming.php">
							<img src="assets/images/service/1.jpg" alt="" />
							<h2>Learn Programming Course</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="datacommunicatin.php">
							<img src="assets/images/service/1.jpg" alt="" />
							<h2>Data communicaton System</h2>
							<p>Learn communicaton System, Develop your Skills and Build your Career in IT Sector.</p>
						</a>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="electrical.php">
							<img src="assets/images/service/2.jpg" alt="" />
							<h2>Learn Electrical Course</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="civil.php">
							<img src="assets/images/service/3.jpg" alt="" />
							<h2>Learn Civil Course</h2>
				...
				<div class="col-md-4 col-sm-6">
					<div class="course-section">
						<a target="_blank" href="architect.php">
							<img src="assets/images/service/3.jpg" alt="" />
							<h2>Learn Architecture Course</h2>
